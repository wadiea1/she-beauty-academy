...
export function CourseCard({ index, title, description, href, ctaLabel }: CourseCardProps) {
  return (
    <article className="group flex flex-col overflow-hidden rounded-[var(--radius-panel)] border border-champagne/60 bg-porcelain transition-shadow duration-300 hover:shadow-[0_24px_48px_-28px_rgba(36,27,22,0.28)]">
